package online.entreprenly.platform.iam.infrastructure.tokens.jwt;
 ...
 * This interface is used to inject the JWT token service in the {@link online.entreprenly.platform.iam.infrastructure.tokens.jwt.services.TokenServiceImpl} class.
 */
